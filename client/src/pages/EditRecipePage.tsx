...
export default function EditRecipePage() {
  ...
  if (loading)
    return (
      <div className="p-8" style={{ color: theme.textMuted }}>
        Loading recipe...
      </div>
    );
      ...
      <form onSubmit={handleSubmit} className="space-y-12 pb-20">
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 rounded text-sm outline-none resize-none mb-4"
                  style={inputStyle}
                />
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <label
                    className="text-xs px-3 py-1.5 rounded border cursor-pointer inline-block"
                    style={{ color: theme.textMuted, borderColor: theme.border }}
                  >
                    {step.photo
                      ? "Change Photo"
        ...
        >
          <button
            type="submit"
            disabled={saving}
            className="px-10 py-3 rounded-lg text-sm font-bold cursor-pointer disabled:opacity-50"
          ...
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="px-10 py-3 rounded-lg text-sm font-medium border"
