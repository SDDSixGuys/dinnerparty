...
export const createFolder = (payload: {
  ...
  color?: string;
  icon?: string;
}) => folderApiClient.create(payload);
export const updateFolder = (
  id: string,
  data: Partial<Pick<FolderItem, "name" | "color" | "icon" | "sortOrder">>
) => folderApiClient.update(id, data);
export const moveFolder = (id: string, newParentId: string | null) =>
  folderApiClient.move(id, newParentId);
